export const heroContent = {
  ...
  title: "Engineer • Researcher • Deep Learning Builder",
  tagline: "Remote sensing · Edge AI · Systems engineering",
  focus: "I craft precision sensing systems that pair elegant hardware with state-of-the-art perception models.",
  description:
    "Electrical & Electronic Engineering undergraduate at the University of Peradeniya translating satellite data, embedded hardware, and machine learning into research-grade products.",
  location: "Kandy, Sri Lanka",
  email: "nichula2001@gmail.com",
  image: "/images/profile2.jpg",
  highlights: [
    { label: "Research Impact", value: "4 publications under review" },
    { label: "Deep Learning", value: "UrbanMamba & U-Net pipelines" },
    { label: "Collaboration", value: "Available for 2025 fellowships" }
  ]
};

export const aboutContent = {
  paragraphs: [
    "I blend research thinking with engineering discipline—going from ideation to working prototypes that withstand real-world constraints.",
    "My current focus: remote sensing change detection, low-power embedded sensing, and deep-learning architectures that can be deployed at the edge."
  ],
  focusAreas: ["Remote sensing", "Edge AI", "Systems integration", "Scientific storytelling"],
  quote:
    "I believe in premium, purposeful engineering: calm interfaces, explainable models, and instrumentation that scientists can trust.",
...
export const education = [
  ...
  },
  {
    ...
    school: "Kandy District",
    period: "2021",
    details: ["National Rank: 147 · District Rank: 15", "Z-Score: 2.5138"],
...
export const projects = [
  {
    ...
    year: "2024",
    description:
      "End-to-end IoT solution with AI-based disease detection, automated irrigation, and climate control. Built a web dashboard for real-time environmental monitoring and control.",
    stack: ["Raspberry Pi", "ESP32", "Arduino", "Python", "Web dashboard"],
    image: "/images/implementedgreenhouse.jpg",
    links: [
      { label: "GitHub", href: "https://github.com/nichula01/smart-greenhouse" },
      { label: "View Project", href: "/greenhouse" },
      { label: "Demo", href: "https://www.youtube.com/watch?v=cL97SUo4XJA" }
    ]
  },
  {
    ...
    year: "2025",
    description:
      "ResNet-34 U-Net for binary segmentation of high-resolution satellite imagery. Delivered IoU 0.848 / F1 0.884 on Mumbai datasets.",
    stack: ["PyTorch", "U-Net", "Remote sensing", "ResNet-34"],
    image: "/images/slum.png",
    links: [
      { label: "GitHub", href: "https://github.com/nichula01/Slum-Detection-Using-Unet-Architecture" },
      { label: "View Project", href: "/slum" }
    ]
  },
  {
    title: "UrbanMamba Semantic Segmentation",
    year: "Ongoing",
    description:
    ...
    stack: ["Mamba architecture", "Semantic segmentation", "PyTorch"],
    image: "/images/Urbanmamba.png"
  },
  {
    title: "Analog + Embedded Semester Projects",
    year: "2022 – 2023",
    description:
      "Hands-on hardware design and electronics projects completed during undergraduate coursework.",
    stack: ["Digital electronics", "Sensors", "Embedded systems"],
    image: "/images/linefollow1.jpg",
    details: [
      "Line Following Robot using analog electronics implemented with logic gates and flip-flops for real-time control and navigation.",
      "Pulse Rate Monitoring wearable built around a piezoelectric sensor to measure human pulse rate accurately."
    ],
...
export const skillCategories = [
  {
    ...
    items: [
      ...
      { name: "PyTorch / Lightning", level: "88%" },
      { name: "OpenCV", level: "78%" },
      { name: "TensorBoard / WandB", level: "72%" }
    ]
  },
  {
    ...
    items: [
      ...
      { name: "QGIS / ArcGIS", level: "82%" },
      { name: "Hyperspectral Analysis", level: "74%" },
      { name: "GDAL / Raster Vision", level: "70%" }
    ]
  },
  {
...
export const contactInfo = {
  ...
  location: "Kandy, Sri Lanka",
  formAction: "https://formspree.io/f/mjkoqopo"
};
